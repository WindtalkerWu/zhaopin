...
ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener {
	...
	private int m_nDeltaY = 0;
	private int m_nIncrementalDeltaY = 0;
	private boolean m_bMoveing = false;
	...
	boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
		...
		m_nDeltaY = m_nDeltaY + deltaY;
        m_nIncrementalDeltaY = m_nIncrementalDeltaY + incrementalDeltaY;
    ...
    public void MoveTop(){
    	m_bMoveing = true;
    	while(m_bMoveing){
//    		Move(-m_nDeltaY, -m_nIncrementalDeltaY);
    		Move(5000, 5000);
    	}
    	m_nDeltaY = 0;
    	m_nIncrementalDeltaY = 0;
    	invalidate();
    }
    
    boolean Move(int deltaY, int incrementalDeltaY) {
        final int childCount = getChildCount();
        if (childCount == 0) {
        	m_bMoveing = false;
            return true;
