...
public class Util {
    ...
    public static boolean checkMobileFormate(String phone) {
        String formate = "^((13[0-9])|(14[0-9])|(15[0-9])|(17[0-9])|(18[0-9]))\\d{8}$";
        final Pattern PHONE_PATTERN = Pattern.compile(formate);
