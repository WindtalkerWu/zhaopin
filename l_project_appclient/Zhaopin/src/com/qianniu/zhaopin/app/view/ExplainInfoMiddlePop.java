...
public class ExplainInfoMiddlePop extends PopupWindow implements OnTouchListener{
	private Context mContext;
	private LayoutInflater mInflater;
	private TextView info_tv;
	
	public ExplainInfoMiddlePop(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub

		mContext = context;
		mInflater = LayoutInflater.from(context);
		View contentView = mInflater.inflate(R.layout.explaininfo_middle_layout, null);
	...
	public ExplainInfoMiddlePop(Context context) {
		this(context,null);
		// TODO Auto-generated constructor stub
	}
