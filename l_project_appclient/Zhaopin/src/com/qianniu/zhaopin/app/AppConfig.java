...
import com.qianniu.zhaopin.app.bean.AccessInfo;
...
public class AppConfig {
	...
	public final static String CONF_BDPUSH_USERID = "bdpush_userid";
	public final static String CONF_BDPUSH_CHANNELID = "bdpush_channelid";

	public final static String SAVE_IMAGE_PATH = "save_image_path";
	public final static String SDCARD_FILE_ROOT = "matrix/";
	public final static String SDCARD_IMAGE_ROOT = SDCARD_FILE_ROOT + "image/";
	public final static String SDCARD_IMAGE_START = SDCARD_FILE_ROOT + "start/";    //启动界面图片缓存
	public final static String DEFAULT_SAVE_IMAGE_ABSOLUTE_PATH = Environment.getExternalStorageDirectory()+ File.separator+ SDCARD_IMAGE_ROOT;
	public final static String START_SAVE_IMAGE_ABSOLUTE_PATH = Environment.getExternalStorageDirectory()+ File.separator+ SDCARD_IMAGE_START;
