...
//		progress_head = (ProgressBar) findViewById(R.id.foruminfo_detail_head_progress);
		...
		btn_share.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// TODO Auto-generated method stub
				if(null != m_umShare){
					m_umShare.umOpenShare(ForumInfoDetailActivity.this);
				}
//				UIHelper.showShareDialog(ForumInfoDetailActivity.this, "我在牵牛网分享资讯给您","我在牵牛网分享资讯给您。 \n" +mUrl);
				UIHelper.showShareDialog(ForumInfoDetailActivity.this, 
						"我在牵牛网分享资讯给您", "我在牵牛网分享资讯给您。 \n", mUrl);
			}
		});
	...
	public void initWebView() {
		...
		if (mUrl != null){
			String httpurl = URLs.formatURL(mUrl);
			loadurl(mwebview, httpurl);
		}
	}
