...
public class SearchResultPostFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		MyLogger.i(getTag(), "SearchResultPostFragment##onActivityCreated");
...
//				intent.putExtra("searchType", SearchResultDetailActivity.SEARCH_POST);
...
//		});
	...
	class ResultPostViewHolder {
		...
		public ResultPostViewHolder(View view) {
			...
			companyName = (TextView) view.findViewById(R.id.exposure_search_result_item_company);
		}
	}
