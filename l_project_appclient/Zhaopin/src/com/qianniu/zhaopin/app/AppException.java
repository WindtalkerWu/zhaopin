...
public class AppException extends Exception implements UncaughtExceptionHandler{
	...
	private AppException(byte type, int code, Exception excp) {
		...
		this.type = type;
		this.code = code;	
		MyLogger.e(TAG, "type = "+ type+",code = "+code+",excp = "+excp);
		if(Debug){
...
/*			String err = ctx.getString(R.string.http_status_code_error, this.getCode());
			...
			Toast.makeText(ctx, R.string.dialog_data_get_err, Toast.LENGTH_SHORT).show();
			break;
		...
		case TYPE_SOCKET:
			...
			Toast.makeText(ctx, R.string.http_link_exception, Toast.LENGTH_SHORT).show();
			break;
		case TYPE_NETWORK:
		...
		case TYPE_RUN:
			...
			break;
		default:
			Toast.makeText(ctx, R.string.do_error, Toast.LENGTH_SHORT).show();
			break;
		}
	}
